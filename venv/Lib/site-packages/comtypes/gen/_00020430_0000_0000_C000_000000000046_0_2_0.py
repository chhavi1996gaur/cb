...
IFontDisp = Font
__all__ = [ 'Monochrome', 'IFontEventsDisp', 'OLE_CANCELBOOL',
           'IPicture', 'Unchecked', 'OLE_HANDLE', 'FONTSIZE',
           'OLE_XPOS_PIXELS', 'IPictureDisp', 'OLE_YPOS_HIMETRIC',
           'OLE_TRISTATE', 'OLE_XPOS_CONTAINER', 'Gray', 'Font',
           'FontEvents', 'FONTUNDERSCORE', 'IFontDisp', 'FONTNAME',
           'OLE_XSIZE_PIXELS', 'Default', 'Picture', 'StdFont',
           'OLE_XSIZE_CONTAINER', 'Checked', 'LoadPictureConstants',
           'Color', 'FONTBOLD', 'FONTSTRIKETHROUGH', 'VgaColor',
           'OLE_YPOS_PIXELS', 'StdPicture', 'OLE_YSIZE_PIXELS',
           'FONTITALIC', 'OLE_COLOR', 'OLE_YPOS_CONTAINER',
           'OLE_XPOS_HIMETRIC', 'OLE_YSIZE_HIMETRIC', 'IFont',
